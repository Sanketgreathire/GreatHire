...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="fixed top-4 left-4 z-40 md:hidden bg-blue-700 text-white p-3 rounded-lg shadow-lg"
      ...
      <div
        className={`
          fixed inset-y-0 left-0 z-40 bg-white flex flex-col
      ...
      >
        ...
        <div className="border-t border-gray-300 p-4">
          <NavLink
            ...
            onClick={() => setIsOpen(false)}
            className="flex items-center gap-3 py-2 px-4 rounded hover:bg-gray-100"
          >
            {user ? (
              <>
                <img

          ...
          <div className="relative h-screen w-2/3 hidden xl:flex">
            <div className="absolute inset-0 flex flex-col items-center text-center space-y-4 justify-center px-4">
              <div className="mt-20 text-gray-900">
                ...
                <ul className="text-lg font-semibold text-gray-900 space-y-2">
                  {["Create An Account", "Create Your Company", "Post Jobs"].map(
                    (step, index) => (
                      <li
                        key={index}
...
>>>>>>> Stashed changes
                ...
                {[
                  ...
                  <p
                    key={index}
                    className="flex items-center gap-2 font-semibold text-sm md:text-lg text-gray-800"
                  >
          ...
          <div className="w-full xl:w-1/3 flex justify-center py-8 mb-16">
            <form
              className="w-full max-w-md space-y-5 px-6"
            ...
            >
              ...
              <p className="text-center text-sm text-gray-500">
                ...
                <button
                  type="button"
                  onClick={() => navigate("/admin/login")} // yaha direct navigate
              ...
              <button
                type="submit"
                className={`w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 ${loading ? "cursor-not-allowed" : ""
                  }`}
                disabled={loading}
              >

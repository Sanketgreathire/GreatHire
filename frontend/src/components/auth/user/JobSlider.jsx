            ...
            try {
                ...
                if (data.success) {
                    ...
                    const transformedJobs = data.jobs.map((job, index) => ({
                        ...
                        badge: Math.random() > 0.5 ? 'New' : 'Hot',
                        badgeColor: Math.random() > 0.5
                            ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300'
                            : 'bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-400',
                        icon: [Briefcase, Users, Megaphone, BarChart3][index % 4],
                        iconBg: ['bg-blue-100 dark:bg-blue-900/50', 'bg-purple-100 dark:bg-purple-900/50', 'bg-pink-100 dark:bg-pink-900/50', 'bg-green-100 dark:bg-green-900/50'][index % 4],
                        iconColor: ['text-blue-600 dark:text-blue-400', 'text-purple-600 dark:text-purple-400', 'text-pink-600 dark:text-pink-400', 'text-green-600 dark:text-green-400'][index % 4],
                    }));

                    setJobs([...transformedJobs, ...demojobs]);
                }
            } catch (error) {

...
import { DIGITAL_MARKETER_API_END_POINT } from "@/utils/ApiEndPoint";

const DigitalMarketerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${DIGITAL_MARKETER_API_END_POINT}/login`,
        {
          ...formData,
        },
...
export default DigitalMarketerLogin;

...
const Locations = ({ locations, onSelectLocation }) => {
  return (
    <>
      ...
      <div className="absolute top-16 left-0 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg shadow-lg dark:shadow-2xl w-full max-h-64 overflow-auto z-20 transition-colors duration-300">
        ...
        {locations.length > 0 ? (
          ...
          <div className="px-4 py-2 text-gray-500 dark:text-gray-400">No locations found</div>
        )}
      </div>
    </>
  );

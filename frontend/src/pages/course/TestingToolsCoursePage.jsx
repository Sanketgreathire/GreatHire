...
const TOOLS = [
  { name: "Selenium", color: "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300", icon: "🌐" },
  { name: "Java", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "☕" },
  { name: "TestNG", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "✅" },
  { name: "Postman", color: "bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300", icon: "📮" },
  { name: "Rest Assured", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300", icon: "🔗" },
  { name: "JMeter", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "⚡" },
  { name: "Jira", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200", icon: "🐛" },
  { name: "Jenkins", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "🔧" },
  { name: "Maven", color: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300", icon: "📦" },
  { name: "Cucumber BDD", color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300", icon: "🥒" },
  { name: "Git & GitHub", color: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200", icon: "🐙" },
  { name: "ISTQB Prep", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300", icon: "🎖️" },
];
    ...
    <div className={`border rounded-xl overflow-hidden transition-all duration-200 ${isOpen ? "border-green-300 dark:border-green-600 shadow-sm" : "border-gray-200 dark:border-gray-700"}`}>
      <button onClick={onToggle} className="w-full flex items-center justify-between px-5 py-4 text-left bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/60 transition-colors">
        <div className="flex items-center gap-3 min-w-0">
          <span className="shrink-0 text-xs font-bold bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-300 px-2.5 py-1 rounded-full">{item.module}</span>
      ...
      {isOpen && (
        <div className="px-5 pb-5 bg-green-50/40 dark:bg-gray-800/80 border-t border-green-100 dark:border-gray-700">
          <p className="text-xs text-green-600 dark:text-green-400 font-semibold mb-3 mt-3 uppercase tracking-wider">Topics Covered</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700"><p className="text-xs text-teal-600 dark:text-teal-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p><h3 className="text-xl font-black text-gray-900 dark:text-white">Testing Tools</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">🎯 Free demo class — no commitment required!</p></div>
...
export default function TestingToolsCoursePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Banner */}
      <section className="bg-gradient-to-br from-slate-900 via-green-950 to-green-900 dark:from-gray-950 dark:via-green-950 dark:to-slate-900 text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.8</span><span className="text-xs text-gray-400">(3,500+ reviews)</span></div>
          ...
          <div className="lg:col-span-2 space-y-14">
            ...
            <section>
              ...
              <div className="bg-green-50 dark:bg-gray-800/60 border border-green-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-4">The <strong className="text-gray-900 dark:text-white">Testing Tools Course</strong> at Great Hire is a comprehensive 4-month program covering Manual Testing, Selenium WebDriver with Java, TestNG, API Testing (Postman + Rest Assured), JMeter Performance Testing, and CI/CD integration with Jenkins. You'll build a complete automation framework from scratch.</p>
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">With real-world project experience, ISTQB exam preparation, and direct placement support through Great Hire's IT hiring network, this course is your gateway to a quality assurance career at top tech companies.</p>
              </div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.8</span><span className="text-xs text-gray-400">(3,500+)</span></div>
              ...
              <div className="bg-gradient-to-br from-green-600 to-green-800 dark:from-green-700 dark:to-green-900 rounded-2xl p-5 text-white text-center">
      ...
      {/* Footer CTA Banner */}
      <section className="bg-gradient-to-r from-green-700 to-green-900 dark:from-green-800 dark:to-green-950 py-14 mt-10">
      ...
      <Suspense fallback={null}>
        {showCounsellor && <TalkToCounsellorModal courseName="Testing Tools" onClose={() => setShowCounsellor(false)} />}
      </Suspense>
    </div>
  );
}
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className={`w-full text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1 ${isIIT ? "bg-orange-500 hover:bg-orange-600" : "bg-pink-600 hover:bg-pink-700"}`}
              >

...
const TOOLS = [
  { name: "Photoshop", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "🖼️" },
  { name: "Illustrator", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "✏️" },
  { name: "Premiere Pro", color: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300", icon: "🎬" },
  { name: "After Effects", color: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", icon: "✨" },
  { name: "Figma", color: "bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300", icon: "🎨" },
  { name: "Blender", color: "bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300", icon: "🧊" },
  { name: "InDesign", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "📰" },
  { name: "Audition", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300", icon: "🎵" },
  { name: "Canva Pro", color: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300", icon: "🖌️" },
  { name: "DaVinci Resolve", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "🎥" },
];
    ...
    <div className={`border rounded-xl overflow-hidden transition-all duration-200 ${isOpen ? "border-pink-300 dark:border-pink-600 shadow-sm" : "border-gray-200 dark:border-gray-700"}`}>
      <button onClick={onToggle} className="w-full flex items-center justify-between px-5 py-4 text-left bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/60 transition-colors">
        ...
        <div className="flex items-center gap-3 shrink-0 ml-2">
          ...
          <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${isOpen ? "bg-pink-600 text-white rotate-180" : "bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300"}`}>
  ...
  const handlePay = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/courses/payment/create-order`, {
        ...
        body: JSON.stringify({ ...form, courseName: "Multimedia - IIT Certification Program", amount: 60000 }),
      });
      ...
      const options = {
        ...
        name: "GreatHire",
        description: "Multimedia IIT Certification Program",
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {step === "done" ? (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Welcome to the Multimedia IIT Certification Program! Our team will contact you within 2 hours.</p>
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">Multimedia Course — ₹60,000</h3>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700"><p className="text-xs text-rose-600 dark:text-rose-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p><h3 className="text-xl font-black text-gray-900 dark:text-white">Multimedia</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">🎯 Free demo class — no commitment required!</p></div>
            <div className="space-y-4">
              {[
                { label: "Full Name", key: "name", type: "text", placeholder: "Your full name" },
                { label: "Email Address", key: "email", type: "email", placeholder: "you@example.com" },
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          <div className="p-8 text-center">
            <div className="text-5xl mb-4">🎉</div>
            <h3 className="text-xl font-black text-gray-900 dark:text-white mb-2">You're in!</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Our counsellor will call you within 2 hours to confirm your batch and share details.</p>
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700">
              <p className="text-xs text-pink-500 dark:text-pink-400 font-bold uppercase tracking-widest mb-1">Enroll Now</p>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">Multimedia Course</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">⚡ Limited seats — next batch starts soon!</p>
            </div>
            <div className="space-y-4">
              {[
                { label: "Full Name", key: "name", type: "text", placeholder: "Your full name" },
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 dark:bg-gray-700 dark:text-white ${
                      errors[key] ? "border-red-500" : "border-gray-200 dark:border-gray-600"
                    }`}
                  />
                  {errors[key] && <p className="text-red-500 text-xs mt-1 font-medium">{errors[key]}</p>}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Batch</label>
                  <select value={form.batch} onChange={(e) => setForm({ ...form, batch: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400">
                    <option className="dark:bg-gray-800">Weekday Batch</option><option className="dark:bg-gray-800">Weekend Batch</option><option className="dark:bg-gray-800">Fast Track</option>
                  </select>
                </div>
                <div>
                  <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Mode</label>
                  <select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400">
                    <option className="dark:bg-gray-800">Online</option><option className="dark:bg-gray-800">Offline</option><option className="dark:bg-gray-800">Hybrid</option>
                  </select>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-3xl font-black text-pink-600 dark:text-pink-400 mb-1">₹38,000</p>
      ...
      <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div>
            <p className="text-xl font-black text-pink-600 dark:text-pink-400 leading-none">₹38,000</p>
            ...
            <section>
              ...
              <div className="bg-pink-50 dark:bg-gray-800/60 border border-pink-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-4">
                  The <strong className="text-gray-900 dark:text-white">Multimedia Design Course</strong> at Great Hire is a 6-month creative career program that takes you from design basics to professional-grade work in graphic design, video editing, motion graphics, and UI/UX design using the full Adobe Creative Suite and Figma.
                </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {HIGHLIGHTS.map((h) => (
                  <div key={h.title} className="flex gap-4 p-5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl hover:border-pink-200 dark:hover:border-pink-600 hover:shadow-sm transition-all group">
                    <div className="w-11 h-11 bg-pink-50 dark:bg-gray-700 group-hover:bg-pink-100 dark:group-hover:bg-gray-600 rounded-xl flex items-center justify-center text-xl shrink-0 transition-colors">
                      {h.icon}
                    </div>
                    <div>
                ...
                {BATCHES.map((b) => (
                  <div key={b.type} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border gap-4 ${b.urgent ? "border-pink-300 dark:border-pink-600 bg-pink-50/50 dark:bg-gray-800/80" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"}`}>
                    <div className="flex items-center gap-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl shrink-0 ${b.urgent ? "bg-pink-100 dark:bg-pink-900/50" : "bg-gray-100 dark:bg-gray-700"}`}>
                        📅
                      </div>
                      <div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                ...
                <p className="text-3xl font-black text-pink-600 dark:text-pink-400 leading-none mb-1">₹38,000</p>
              ...
              {/* Refer card */}
              <div className="bg-gradient-to-br from-pink-600 to-rose-700 dark:from-pink-700 dark:to-rose-800 rounded-2xl p-5 text-white text-center">
      ...
      {/* ── CTA Banner ── */}
      <section className="bg-gradient-to-r from-pink-700 to-rose-700 dark:from-pink-800 dark:to-rose-800 py-14 mt-10">

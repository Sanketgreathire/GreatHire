            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative">
                ...
                {done ? (
                    <div className="p-8 text-center">
                        ...
                        <button onClick={onClose} className="bg-sky-500 text-white px-8 py-3 rounded-xl font-semibold text-sm hover:bg-sky-600">Got it!</button>
                    </div>
                ) : (
                    <div className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <select value={form.batch} onChange={(e) => setForm({ ...form, batch: e.target.value })} className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400">
                                ...
                                <div>
                                    ...
                                    <select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-400">

...
const TESTIMONIALS = [
  ...
  {
    name: "Priya Lakshmi",
    role: "BIM Coordinator @ Shapoorji Pallonji",
    avatar: "PL",
    color: "bg-teal-500",
    rating: 5,
...
const FAQS = [
  ...
  },
  {
    ...
    a: "The course fee is ₹28,000 inclusive of all software training, project files, certification prep, and placement support. EMI starting ₹2,800/month available.",
  },
  {
  ...
  return (
    <div className="rounded-2xl overflow-hidden border-2 border-orange-400 shadow-lg">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-500 px-5 py-3 text-center">
        <p className="text-white font-black text-sm tracking-wide">🎓 IIT Certification Program</p>
      </div>
      ...
      <div className="bg-white px-5 py-3 flex items-center justify-center gap-3 border-b border-gray-100">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm font-black text-blue-700">
            Teks <span className="text-orange-500">academy</span>
            <sup className="text-gray-400 text-xs">®</sup>
          </span>
        </div>
        <span className="text-gray-400 font-bold text-lg">+</span>
        <div className="flex items-center gap-1.5">
          <div className="bg-[#0A66C2] rounded px-1.5 py-0.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 leading-none">Knowledge Partner</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 px-5 pt-4 pb-4">
        <div className="flex items-baseline gap-2 mb-0.5">
          <p className="text-2xl font-black text-gray-900">Rs. 60,000</p>
          <span className="text-xs font-semibold text-gray-500">+ 18% GST</span>
        </div>
        <p className="text-xs text-gray-500 mb-4">*Pay in easy EMIs starting at INR 7,000 per month.</p>
...
// ─── IIT Certification Section (Main Content) ─────────────────────────────────
    ...
    <section>
      ...
      <div className="rounded-2xl border-2 border-orange-400 overflow-hidden shadow-md">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 px-6 py-4 flex items-center justify-between">
          ...
          <span className="bg-white text-orange-600 text-xs font-black px-3 py-1 rounded-full shrink-0">Premium</span>
        </div>

        <div className="bg-white p-6">
          {/* Partner logos */}
          <div className="flex flex-wrap items-center gap-5 pb-5 mb-5 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              <div className="bg-[#0A66C2] rounded px-2 py-0.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <p className="text-3xl sm:text-4xl font-black text-gray-900">Rs. 60,000</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={onEnroll}
                  className="bg-orange-500 hover:bg-orange-600 text-white font-black px-7 py-3.5 rounded-xl text-sm transition-colors"
                >
                  Enroll Now
                </button>
                <button className="border-2 border-orange-400 text-orange-500 hover:bg-orange-50 font-semibold px-5 py-3.5 rounded-xl text-sm transition-colors">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative">
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <button
              onClick={onClose}
              className={`text-white px-8 py-3 rounded-xl font-semibold text-sm ${isIIT ? "bg-orange-500 hover:bg-orange-600" : "bg-teal-600 hover:bg-teal-700"}`}
            >
              Got it!
            </button>
          </div>
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 ${isIIT ? "focus:ring-orange-500" : "focus:ring-teal-500"}`}
                  />
                </div>
              ))}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className={`w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 ${isIIT ? "focus:ring-orange-500" : "focus:ring-teal-500"}`}
                  >
    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white rounded-2xl shadow-2xl p-6 text-gray-900">
                ...
                <p className="text-3xl font-black text-teal-600 mb-1">₹28,000</p>
      ...
      <div className="lg:hidden bg-white border-b border-gray-200 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div>
            <p className="text-xl font-black text-teal-600 leading-none">₹28,000</p>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
                ...
                <p className="text-3xl font-black text-teal-600 leading-none mb-1">₹28,000</p>

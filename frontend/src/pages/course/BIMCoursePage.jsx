...
const TOOLS = [
  { name: "Autodesk Revit", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "🏗️" },
  { name: "Navisworks", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "🔍" },
  { name: "AutoCAD", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "📐" },
  { name: "BIM 360 / ACC", color: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", icon: "☁️" },
  { name: "Dynamo", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300", icon: "⚙️" },
  { name: "Lumion", color: "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300", icon: "🌿" },
  { name: "SketchUp", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300", icon: "🧊" },
  { name: "Revizto", color: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300", icon: "🔗" },
  { name: "MS Project", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200", icon: "📅" },
  { name: "3ds Max", color: "bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300", icon: "🎨" },
  { name: "Fuzor", color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300", icon: "🏢" },
  { name: "IFC / COBie", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "📋" },
];
...
function EnrollModal({ onClose }) {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      setErrors({ name: "", email: "", phone: err.message || "Something went wrong. Please try again." });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {step === "done" ? (
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Welcome to the BIM Employment Program! Our team will contact you within 2 hours.</p>
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700">
              <p className="text-xs text-teal-600 dark:text-teal-400 font-bold uppercase tracking-widest mb-1">Employment Program</p>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">BIM Course — ₹38,000</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select value={form.batch} onChange={(e) => setForm({ ...form, batch: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                ...
                <div>
                  ...
                  <select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700"><p className="text-xs text-rose-600 dark:text-rose-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p><h3 className="text-xl font-black text-gray-900 dark:text-white">BIM</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">🎯 Free demo class — no commitment required!</p></div>
            <div className="space-y-4">
              {[
                { label: "Full Name", key: "name", type: "text", placeholder: "Your full name" },
                { label: "Email Address", key: "email", type: "email", placeholder: "you@example.com" },
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {step === "done" ? (
          <div className="p-8 text-center">
            <div className="text-5xl mb-4">🎉</div>
            <h3 className="text-xl font-black text-gray-900 dark:text-white mb-2">Payment Successful!</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Welcome to the BIM IIT Certification Program! Our team will contact you within 2 hours.</p>
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">BIM Course — ₹60,000</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">+ 18% GST · EMI from ₹7,000/month</p>
            </div>
            <div className="space-y-4">
              {[
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
      ...
      <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div>
            <p className="text-xl font-black text-teal-600 dark:text-teal-400 leading-none">₹38,000</p>
          ...
          <div className="lg:col-span-2 space-y-14">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {HIGHLIGHTS.map((h) => (
                  <div key={h.title} className="flex gap-4 p-5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl hover:border-teal-200 dark:hover:border-teal-600 hover:shadow-sm transition-all group">
                    <div className="w-11 h-11 bg-teal-50 dark:bg-gray-700 group-hover:bg-teal-100 dark:group-hover:bg-gray-600 rounded-xl flex items-center justify-center text-xl shrink-0 transition-colors">
                      {h.icon}
                    </div>
                    <div>
            ...
            <section>
              ...
              <div className="mt-4 text-center">
                <button className="text-teal-600 dark:text-teal-400 text-sm font-semibold hover:underline">
                ...
                {BATCHES.map((b) => (
                  <div key={b.type} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border gap-4 ${b.urgent ? "border-teal-300 dark:border-teal-600 bg-teal-50/50 dark:bg-gray-800/80" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"}`}>
                    <div className="flex items-center gap-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl shrink-0 ${b.urgent ? "bg-teal-100 dark:bg-teal-900/50" : "bg-gray-100 dark:bg-gray-700"}`}>
                        📅
                      </div>
                      <div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                ...
                <button className="w-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 rounded-xl text-sm mb-3 transition-colors">
                  📥 Download Syllabus
                </button>
                <button onClick={() => setShowCounsellor(true)} className="w-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 rounded-xl text-sm transition-colors">
                  📞 Talk to Counsellor
              ...
              {/* Refer card */}
              <div className="bg-gradient-to-br from-teal-600 to-teal-700 dark:from-teal-700 dark:to-teal-800 rounded-2xl p-5 text-white text-center">
      ...
      {/* ── CTA Banner ── */}
      <section className="bg-gradient-to-r from-teal-700 to-teal-600 dark:from-teal-800 dark:to-teal-700 py-14 mt-10">

  ...
  const handleSubmit = async () => {
    ...
    try {
      await fetch(`${import.meta.env.VITE_API_URL}/api/v1/courses/enquiry`, {
        ...
        body: JSON.stringify({ ...form, courseName: "Data Analytics", fee: "₹30,499", type: "enrollment" }),
      });
    } catch (_) {}
    setLoading(false);
    setDone(true);
        ...
        {done ? (
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100">
              ...
              <p className="text-sm text-gray-500 mt-1">⚡ Course Fee: <span className="font-bold text-teal-600">₹30,499</span> · EMI from ₹7,000/mo</p>
            </div>
            <div className="space-y-4">
              {[
              ...
              <button onClick={handleSubmit} disabled={loading}
                className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1 disabled:opacity-60">

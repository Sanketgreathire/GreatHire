...
const TOOLS = [
  ...
  { name: "SQL", color: "bg-blue-100 text-blue-700", icon: "🗄️" },
  ...
  { name: "Pandas", color: "bg-indigo-100 text-indigo-700", icon: "🐼" },
  { name: "MySQL", color: "bg-orange-100 text-orange-700", icon: "🔶" },
  { name: "PostgreSQL", color: "bg-indigo-100 text-indigo-800", icon: "🐘" },
  { name: "Looker Studio", color: "bg-teal-100 text-teal-700", icon: "📉" },
  { name: "Power Query", color: "bg-emerald-100 text-emerald-700", icon: "⚙️" },
  { name: "Matplotlib", color: "bg-cyan-100 text-cyan-700", icon: "🎨" },
  { name: "Google Sheets", color: "bg-green-100 text-green-800", icon: "📋" },
];
...
const TESTIMONIALS = [
  ...
  {
    name: "Aditya Verma",
    role: "Analytics Engineer @ Swiggy",
    avatar: "AV",
    color: "bg-green-500",
    rating: 5,
...
const FAQS = [
  ...
  },
  {
    ...
    a: "The course fee is ₹22,000 (inclusive of all materials, tools, datasets & placement support). EMI starts from ₹2,200/month. No cost EMI available on select cards.",
  },
];
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative">
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <button onClick={onClose} className="bg-teal-500 text-white px-8 py-3 rounded-xl font-semibold text-sm hover:bg-teal-600">Got it!</button>
          </div>
        ) : (
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100">
              <p className="text-xs text-teal-600 font-bold uppercase tracking-widest mb-1">Enroll Now</p>
              <h3 className="text-xl font-black text-gray-900">Data Analytics Course</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select value={form.batch} onChange={(e) => setForm({ ...form, batch: e.target.value })} className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
                ...
                <div>
                  ...
                  <select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-400">
              ...
              <button onClick={() => form.name && form.email && form.phone && setDone(true)}
                className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1">
    ...
    <Navbar />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white rounded-2xl shadow-2xl p-6 text-gray-900">
                ...
                <p className="text-3xl font-black text-teal-600 mb-1">₹22,000</p>
                <p className="text-xs text-gray-400 mb-5">EMI from ₹2,200/month · No cost EMI available</p>
                ...
                <button onClick={() => setShowModal(true)} className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mb-3">Book Free Demo Class</button>
      ...
      <div className="lg:hidden bg-white border-b border-gray-200 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div><p className="text-xl font-black text-teal-600 leading-none">₹22,000</p><p className="text-xs text-gray-400">EMI from ₹2,200/mo</p></div>
          <button onClick={() => setShowModal(true)} className="bg-teal-500 text-white font-bold px-5 py-2.5 rounded-xl text-sm whitespace-nowrap">Enroll Now</button>
        </div>
      </div>
                ...
                {BATCHES.map((b) => (
                  <div key={b.type} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border gap-4 ${b.urgent ? "border-teal-300 bg-teal-50" : "border-gray-200 bg-white"}`}>
                    ...
                    <div className="flex items-center gap-3 sm:flex-col sm:items-end">
                      ...
                      <button onClick={() => setShowModal(true)} className="bg-teal-500 hover:bg-teal-600 text-white font-semibold text-xs px-4 py-2 rounded-lg whitespace-nowrap transition-colors">Enroll →</button>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
                ...
                <p className="text-3xl font-black text-teal-600 leading-none mb-1">₹22,000</p>
                <p className="text-xs text-gray-400 mb-5">EMI from ₹2,200/month · No cost EMI</p>
                ...
                <button onClick={() => setShowModal(true)} className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3.5 rounded-xl text-sm mb-3 transition-colors">Book Free Demo Class</button>

...
const TOOLS = [
  { name: "AWS", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300", icon: "☁️" },
  { name: "Docker", color: "bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300", icon: "🐳" },
  { name: "Kubernetes", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "⚓" },
  { name: "Jenkins", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "🔧" },
  { name: "Terraform", color: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300", icon: "🏗️" },
  { name: "Ansible", color: "bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-200", icon: "⚙️" },
  { name: "Git & GitHub", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "🐙" },
  { name: "Linux", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "🐧" },
  { name: "Helm", color: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", icon: "⛵" },
  { name: "SonarQube", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300", icon: "🔍" },
  { name: "Prometheus", color: "bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300", icon: "📊" },
  { name: "Grafana", color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300", icon: "📈" },
];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          ...
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700"><p className="text-xs text-orange-600 dark:text-orange-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p><h3 className="text-xl font-black text-gray-900 dark:text-white">AWS & DevOps</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">🎯 Free demo class — no commitment required!</p></div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.9</span><span className="text-xs text-gray-400">(3,200+ reviews)</span></div>
      ...
      <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div><p className="text-xl font-black text-orange-500 dark:text-orange-400 leading-none">₹38,000</p><p className="text-xs text-gray-400 dark:text-gray-400">EMI from ₹7,000/mo</p></div>
          ...
          <div className="lg:col-span-2 space-y-14">
            ...
            <section>
              ...
              <div className="bg-orange-50 dark:bg-gray-800/60 border border-orange-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-4">The <strong className="text-gray-900 dark:text-white">AWS & DevOps Training Course</strong> at Great Hire is a comprehensive 4-month program covering AWS cloud services, Docker, Kubernetes, Jenkins CI/CD, Terraform, and Ansible. You'll build real CI/CD pipelines and deploy production-grade applications on AWS.</p>
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">With hands-on AWS lab access, 3+ real-world projects, and direct placement support through Great Hire's tech network, this course is your fastest path to a high-paying cloud & DevOps career.</p>
              </div>
            ...
            <section>
              ...
              <div className="mt-4 text-center"><button className="text-orange-500 dark:text-orange-400 text-sm font-semibold hover:underline">📥 Download Complete Syllabus PDF</button></div>
            </section>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.9</span><span className="text-xs text-gray-400">(3,200+)</span></div>
              ...
              <div className="bg-gradient-to-br from-orange-500 to-orange-700 dark:from-orange-600 dark:to-orange-800 rounded-2xl p-5 text-white text-center">
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent("☁️ Check out this AWS & DevOps Course at Great Hire! Get certified and land high-paying cloud roles with 100% placement support.\n" + window.location.href)}`}
                  target="_blank"
      ...
      {/* Footer CTA */}
      <section className="bg-gradient-to-r from-orange-600 to-orange-800 dark:from-orange-700 dark:to-orange-900 py-14 mt-10">

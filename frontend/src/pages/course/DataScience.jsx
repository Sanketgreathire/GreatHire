...
const TOOLS = [
  ...
  { name: "Pandas", color: "bg-blue-100 text-blue-700", icon: "🐼" },
  { name: "NumPy", color: "bg-indigo-100 text-indigo-700", icon: "🔢" },
  { name: "Scikit-Learn", color: "bg-orange-100 text-orange-700", icon: "🤖" },
  { name: "TensorFlow", color: "bg-amber-100 text-amber-700", icon: "🧠" },
  { name: "Keras", color: "bg-red-100 text-red-700", icon: "🔴" },
  { name: "Matplotlib", color: "bg-teal-100 text-teal-700", icon: "📊" },
  { name: "Seaborn", color: "bg-cyan-100 text-cyan-700", icon: "🌊" },
  { name: "Power BI", color: "bg-yellow-100 text-yellow-800", icon: "📈" },
  { name: "Tableau", color: "bg-blue-100 text-blue-800", icon: "🗺️" },
  { name: "SQL", color: "bg-gray-100 text-gray-700", icon: "🗄️" },
  { name: "PySpark", color: "bg-rose-100 text-rose-700", icon: "⚡" },
  { name: "AWS", color: "bg-yellow-100 text-yellow-900", icon: "☁️" },
...
function AccordionItem({ item, isOpen, onToggle }) {
  return (
    <div className={`border rounded-xl overflow-hidden transition-all duration-200 ${isOpen ? "border-violet-300 shadow-sm" : "border-gray-200"}`}>
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between px-5 py-4 text-left bg-white hover:bg-gray-50 transition-colors"
      >
        <div className="flex items-center gap-3 min-w-0">
          <span className="shrink-0 text-xs font-bold bg-violet-100 text-violet-600 px-2.5 py-1 rounded-full">{item.module}</span>
        ...
        <div className="flex items-center gap-3 shrink-0 ml-2">
          ...
          <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${isOpen ? "bg-violet-600 text-white rotate-180" : "bg-gray-100 text-gray-500"}`}>
      ...
      {isOpen && (
        <div className="px-5 pb-5 bg-violet-50/40 border-t border-violet-100">
          <p className="text-xs text-violet-600 font-semibold mb-3 mt-3 uppercase tracking-wider">Topics Covered</p>
...
export default function DataSciencePage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      {/* ── Hero ── */}
      <section className="bg-gradient-to-br from-slate-900 via-violet-950 to-violet-900 text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="hidden lg:block">
              <div className="bg-white rounded-2xl shadow-2xl p-6 text-gray-900">
                ...
                <p className="text-3xl font-black text-violet-600 mb-1">₹38,000 + ₹6,000 (GST)</p>
          ...
          <div className="lg:col-span-2 space-y-14">
            ...
            <section>
              ...
              <div className="bg-violet-50 border border-violet-100 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 text-base leading-relaxed mb-4">
                  The <strong>Data Science & AI Course</strong> at Great Hire is a comprehensive 6-month job-oriented program that takes you from Python basics to deploying machine learning models in production. You'll work on real-world datasets across finance, healthcare, and e-commerce domains.
                </p>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {HIGHLIGHTS.map((h) => (
                  <div key={h.title} className="flex gap-4 p-5 bg-white border border-gray-100 rounded-2xl hover:border-violet-200 hover:shadow-sm transition-all group">
                    <div className="w-11 h-11 bg-violet-50 group-hover:bg-violet-100 rounded-xl flex items-center justify-center text-xl shrink-0 transition-colors">
                      {h.icon}
                    </div>
                    <div>
            ...
            <section>
              ...
              <div className="space-y-4">
                {BATCHES.map((b) => (
                  <div key={b.type} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border gap-4 ${b.urgent ? "border-violet-300 bg-violet-50" : "border-gray-200 bg-white"}`}>
                    <div className="flex items-center gap-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl shrink-0 ${b.urgent ? "bg-violet-100" : "bg-gray-100"}`}>📅</div>
                      <div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-6">
                ...
                <p className="text-3xl font-black text-violet-600 leading-none mb-1">₹38,000 + 18% GST</p>
              ...
              <div className="bg-gradient-to-br from-violet-600 to-indigo-700 rounded-2xl p-5 text-white text-center">
      ...
      {/* ── CTA Banner ── */}
      <section className="bg-gradient-to-r from-violet-700 to-indigo-700 py-14 mt-10">

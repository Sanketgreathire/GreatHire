...
const CURRICULUM = [
  {
    ...
    topics: [
      ...
      "File I/O – CSV, JSON, Excel with Python",
    ],
  },
  {
    module: "Module 2",
    ...
    topics: [
      ...
      "Matplotlib – Line, Bar, Scatter, Heatmaps",
  ...
  },
  {
    ...
    topics: [
      ...
      "TensorFlow & Keras – ANN, CNN, RNN",
      "Computer Vision – Image Classification with CNN",
      "NLP – Text Processing, NLTK, spaCy",
      "Transfer Learning – BERT, ResNet",
      "Generative AI & LLM Basics",
    ],
  },
  {
    module: "Module 6",
    title: "SQL, Big Data & Cloud",
    duration: "2 Weeks",
    topics: [
      "SQL for Data Analysis – Joins, Window Functions",
      "NoSQL – MongoDB for Unstructured Data",
      "Apache Spark – PySpark Basics",
      "Google BigQuery & AWS Athena",
      "Data Pipelines & ETL Concepts",
      "Deploying ML Models on AWS/GCP",
    ],
  },
  {
    module: "Module 7",
    ...
    topics: [
      ...
      "NLP Project – Sentiment Analysis Dashboard",
...
const TOOLS = [
  ...
  { name: "Pandas", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "🐼" },
  { name: "NumPy", color: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", icon: "🔢" },
  { name: "Scikit-Learn", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "🤖" },
  { name: "TensorFlow", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300", icon: "🧠" },
  { name: "Keras", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "🔴" },
  { name: "Matplotlib", color: "bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300", icon: "📊" },
  { name: "Seaborn", color: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300", icon: "🌊" },
  { name: "Power BI", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300", icon: "📈" },
  { name: "Tableau", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200", icon: "🗺️" },
  { name: "SQL", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "🗄️" },
  { name: "PySpark", color: "bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300", icon: "⚡" },
  { name: "AWS", color: "bg-yellow-100 text-yellow-900 dark:bg-yellow-900/60 dark:text-yellow-200", icon: "☁️" },
  { name: "Git & GitHub", color: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200", icon: "🐙" },
];

const HIGHLIGHTS = [
  { icon: "🎯", title: "100% Job Assistance", desc: "Direct referrals to 500+ hiring partners including analytics & AI firms." },
  { icon: "📊", title: "5+ Capstone Projects", desc: "Real datasets from domains like finance, healthcare, e-commerce & NLP." },
  { icon: "👨‍🏫", title: "Industry Expert Trainers", desc: "Learn from Data Scientists with 10+ years at top product companies." },
  { icon: "🏆", title: "Kaggle Competitions", desc: "Participate in live competitions and build a strong public portfolio." },
  ...
  { icon: "💻", title: "LMS Access", desc: "Lifetime access to recorded sessions, datasets, notebooks & material." },
  { icon: "🤝", title: "1-on-1 Mentoring", desc: "Dedicated data science mentor for project guidance and career growth." },
];
...
const TESTIMONIALS = [
  {
    ...
    color: "bg-violet-500",
    rating: 5,
    text: "The Data Science course here is unmatched. From EDA to Deep Learning — every concept is taught with practical datasets. Cracked Amazon's analytics role within 2 months of finishing!",
  },
  {
    name: "Arjun Mehta",
    role: "ML Engineer",
    ...
    color: "bg-blue-500",
    rating: 5,
    text: "Best investment of my career. The ML and DL modules are extremely thorough. Building the churn prediction model from scratch gave me the confidence to ace technical rounds.",
  },
  {
    name: "Divya Lakshmi",
    role: "Data Scientist",
    ...
    color: "bg-pink-500",
    rating: 5,
    text: "The Kaggle competition training and NLP project are phenomenal additions. The trainers are approachable and the curriculum is updated with the latest industry trends.",
  },
];
...
const FAQS = [
  {
    q: "Do I need prior programming or maths knowledge?",
    a: "Basic computer skills are enough to start. We cover Python, statistics, and linear algebra from the ground up. A willingness to learn is all you need.",
  },
  {
    q: "What is the total course duration?",
    a: "The course is 6 months (~115 days). Weekday fast-track batches may complete slightly earlier. All sessions are recorded and available on the LMS.",
  },
  {
    q: "What roles can I apply for after this course?",
    a: "Graduates are placed as Data Analysts, Data Scientists, ML Engineers, Business Intelligence Analysts, and AI Engineers — across domains like fintech, e-commerce, healthcare, and consulting.",
  },
  {
  ...
  },
  {
    ...
    a: "You'll receive a Great Hire Training Certificate and an IIT certificate upon successful course completion.",
  },
  {
...
const PRICING_PLANS = [
  ...
  },
  {
    ...
    emi: "*Pay in easy EMIs starting at INR 7000 per month.",
    features: [
      "Intensive Data Science curriculum covering basic to advanced concepts",
      "100+ Live Data Science classes, Lifetime access",
      "20+ capstone Data Science projects & 1000+ coding problems and assessments",
      "Access to 20,000 + courses from top MNC's",
      "Unlimited AI-driven mock interviews",
...
function AccordionItem({ item, isOpen, onToggle }) {
  return (
    <div className={`border rounded-xl overflow-hidden transition-all duration-200 ${isOpen ? "border-violet-300 dark:border-violet-600 shadow-sm" : "border-gray-200 dark:border-gray-700"}`}>
      <button
        onClick={onToggle}
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <span className="shrink-0 text-xs font-bold bg-violet-100 dark:bg-violet-900/50 text-violet-600 dark:text-violet-300 px-2.5 py-1 rounded-full">{item.module}</span>
        ...
        <div className="flex items-center gap-3 shrink-0 ml-2">
          ...
          <div className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${isOpen ? "bg-violet-600 text-white rotate-180" : "bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300"}`}>
      ...
      {isOpen && (
        <div className="px-5 pb-5 bg-violet-50/40 dark:bg-gray-800/80 border-t border-violet-100 dark:border-gray-700">
          <p className="text-xs text-violet-600 dark:text-violet-400 font-semibold mb-3 mt-3 uppercase tracking-wider">Topics Covered</p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <button onClick={onClose} className="bg-violet-600 text-white px-8 py-3 rounded-xl font-semibold text-sm hover:bg-violet-700">Got it!</button>
          </div>
        ) : (
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700">
              <p className="text-xs text-violet-600 dark:text-violet-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p>
              <h3 className="text-xl font-black text-gray-900 dark:text-white">Data Science & AI</h3>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 dark:bg-gray-700 dark:text-white ${
              ...
              <div><label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Preferred Mode</label><select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"><option className="dark:bg-gray-800">Online</option><option className="dark:bg-gray-800">Offline</option><option className="dark:bg-gray-800">Hybrid</option></select></div>
...
export default function DataSciencePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
      ...
      {/* ── Hero ── */}
      <section className="bg-gradient-to-br from-slate-900 via-violet-950 to-violet-900 dark:from-gray-950 dark:via-violet-950 dark:to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none"
          style={{ backgroundImage: "radial-gradient(circle at 20% 80%, #8b5cf6 0%, transparent 50%), radial-gradient(circle at 80% 20%, #06b6d4 0%, transparent 50%)" }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="lg:col-span-2">
              <div className="flex flex-wrap gap-2 mb-5">
                ...
                <span className="bg-white/10 text-white text-xs font-medium px-3 py-1 rounded-full border border-white/20">Data Science & AI</span>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4">
                Data Science & AI<br />
                <span className="text-yellow-300">Course with ML & DL</span><br />
                <span className="text-2xl sm:text-3xl font-bold text-violet-200">in Hyderabad</span>
              </h1>

              <p className="text-violet-100 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
                Master Python, Machine Learning, Deep Learning, NLP, Power BI, SQL, and AWS with real-world datasets and Kaggle projects. Get placed in top analytics & AI companies through Great Hire's exclusive hiring network.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mt-6 text-xs text-violet-200">
            ...
            <div className="hidden lg:block">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-3xl font-black text-violet-600 dark:text-violet-400 mb-1">₹38,000 + ₹6,000 (GST)</p>
      ...
      <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-16 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div>
            <p className="text-xl font-black text-violet-600 dark:text-violet-400 leading-none">₹38,000</p>
          ...
          <div className="lg:col-span-2 space-y-14">
            ...
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                <span className="w-1 h-7 bg-violet-600 rounded-full inline-block"></span>
                Course Overview
              </h2>
              <div className="bg-violet-50 dark:bg-gray-800/60 border border-violet-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-4">
                  The <strong className="text-gray-900 dark:text-white">Data Science & AI Course</strong> at Great Hire is a comprehensive 6-month job-oriented program that takes you from Python basics to deploying machine learning models in production. You'll work on real-world datasets across finance, healthcare, and e-commerce domains.
                </p>
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">
                  With 5+ capstone projects, Kaggle competition training, and direct placement support through Great Hire's 500+ company network, this course is your fastest path to a data science career in Hyderabad.
                </p>
              </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {HIGHLIGHTS.map((h) => (
                  <div key={h.title} className="flex gap-4 p-5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl hover:border-violet-200 dark:hover:border-violet-600 hover:shadow-sm transition-all group">
                    <div className="w-11 h-11 bg-violet-50 dark:bg-gray-700 group-hover:bg-violet-100 dark:group-hover:bg-gray-600 rounded-xl flex items-center justify-center text-xl shrink-0 transition-colors">
                      {h.icon}
                    </div>
                    <div>
            ...
            <section>
              ...
              <div className="mt-4 text-center">
                <button className="text-violet-600 dark:text-violet-400 text-sm font-semibold hover:underline">
            ...
            <section>
              ...
              <div className="space-y-4">
                {BATCHES.map((b) => (
                  <div key={b.type} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border gap-4 ${b.urgent ? "border-violet-300 dark:border-violet-600 bg-violet-50/50 dark:bg-gray-800/80" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"}`}>
                    <div className="flex items-center gap-4">
                      <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl shrink-0 ${b.urgent ? "bg-violet-100 dark:bg-violet-900/50" : "bg-gray-100 dark:bg-gray-700"}`}>📅</div>
                      <div>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                ...
                <p className="text-3xl font-black text-violet-600 dark:text-violet-400 leading-none mb-1">₹38,000 + 18% GST</p>
                ...
                <button className="w-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 rounded-xl text-sm transition-colors">
                  📥 Download Syllabus
                </button>
                <button onClick={() => setShowCounsellor(true)} className="w-full border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 rounded-xl text-sm transition-colors">
                  📞 Talk to Counsellor
              ...
              <div className="bg-gradient-to-br from-violet-600 to-indigo-700 dark:from-violet-700 dark:to-indigo-800 rounded-2xl p-5 text-white text-center">
      ...
      {/* ── CTA Banner ── */}
      <section className="bg-gradient-to-r from-violet-700 to-indigo-700 dark:from-violet-800 dark:to-indigo-800 py-14 mt-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
            Start Your Data Science Journey Today
          </h2>
          <p className="text-violet-100 text-base sm:text-lg mb-8 leading-relaxed">
      ...
      <Suspense fallback={null}>
        {showEnroll && <CourseEnrollModal onClose={() => setShowEnroll(false)} courseName="Data Science & AI" amount={enrollAmount} accentColor="violet" />}
        {showCounsellor && <TalkToCounsellorModal courseName="Data Science & AI" onClose={() => setShowCounsellor(false)} />}
      </Suspense>
    </div>
  );
}
...
const CURRICULUM = [
  {
    ...
    duration: "1 Week",
    topics: [
      "Introduction to Business Analysis & BABOK",
      "Role of a Business Analyst in Organizations",
      "Types of BA – IT BA, Functional BA, Domain BA",
      "SDLC & Agile Methodologies Overview",
  ...
  },
  {
    ...
    topics: [
      ...
      "Swimlane Diagrams & Workflow Modelling",
      "MS Visio & Lucidchart for Process Diagrams",
    ],
  },
  {
    module: "Module 4",
    ...
    topics: [
      ...
      "Product Backlog Grooming & Sprint Planning",
      "Writing Effective User Stories & Epics",
      "Story Pointing & Velocity",
      "Kanban Boards & Jira for Backlog Management",
      "BA Role in Scrum Teams",
    ],
  },
  {
    module: "Module 5",
    title: "Data Analysis & SQL for BA",
    duration: "2 Weeks",
    topics: [
      "SQL Basics – SELECT, Joins, Aggregations",
      "Data Analysis using Excel – Pivot, VLOOKUP",
      "Power BI Dashboards for Stakeholder Reporting",
      "KPI Definition & Metrics Design",
      "Data Validation & Quality Checks",
      "A/B Testing Concepts for Business Decisions",
    ],
  },
  {
    module: "Module 6",
    title: "UAT, Change Management & Tools",
    duration: "1 Week",
    topics: [
      "User Acceptance Testing (UAT) Planning",
      "Test Case Writing & Bug Reporting",
      "Change Management Fundamentals",
      "JIRA, Confluence & Trello for BA",
      "Wireframing with Balsamiq & Figma",
  ...
  },
  {
    ...
    duration: "2 Weeks",
    topics: [
      "End-to-End BA Project – E-Commerce Platform",
      "BRD, SRS & Use Case Documentation Project",
      "Agile Sprint Simulation",
      "Case Study Practice – FAANG-style BA Rounds",
...
const TOOLS = [
  { name: "MS Visio", color: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", icon: "📐" },
  { name: "JIRA", color: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300", icon: "🎯" },
  { name: "Confluence", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-200", icon: "📝" },
  { name: "Balsamiq", color: "bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300", icon: "🖼️" },
  { name: "Lucidchart", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300", icon: "🔷" },
  { name: "Power BI", color: "bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300", icon: "📊" },
  { name: "Excel", color: "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300", icon: "📋" },
  { name: "SQL", color: "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300", icon: "🗄️" },
  { name: "Figma", color: "bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300", icon: "🎨" },
  { name: "Trello", color: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300", icon: "📌" },
  { name: "Miro", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-300", icon: "🟡" },
  { name: "MS Office", color: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300", icon: "📄" },
];

const HIGHLIGHTS = [
  { icon: "🎯", title: "100% Job Assistance", desc: "Direct referrals to 500+ hiring partners including top MNCs and product firms." },
  { icon: "📋", title: "Real BRD & SRS Projects", desc: "Create industry-standard documents used in actual enterprise projects." },
  { icon: "👨‍🏫", title: "Certified BA Trainers", desc: "Learn from BAs with 10+ years across BFSI, IT, e-commerce & consulting." },
  { icon: "🏃", title: "Agile Sprint Simulation", desc: "Live Scrum sprints with real backlog grooming and stakeholder sessions." },
  ...
  { icon: "💻", title: "LMS Access", desc: "Lifetime access to recorded sessions, templates & interview resources." },
  { icon: "🤝", title: "1-on-1 Mentoring", desc: "Dedicated BA mentor for documentation review and career guidance." },
];

const TESTIMONIALS = [
  {
    name: "Preethi Subramaniam",
    role: "Business Analyst @ Capgemini",
    avatar: "PS",
    color: "bg-indigo-500",
    rating: 5,
    text: "The BRD and use case modules are incredibly practical. The Agile sprint simulation gave me the confidence to walk into my Capgemini interview and ace every scenario question. Placed in 40 days!",
  },
  {
    name: "Rajan Mehta",
    ...
    color: "bg-blue-500",
    rating: 5,
    text: "Best BA course in Hyderabad, period. The JIRA and Confluence training combined with SQL made me stand out in every interview. Got 3 offers within 2 months of completing the course.",
  },
  {
    name: "Lakshmi Priya",
    role: "IT Business Analyst @ Wipro",
    avatar: "LP",
    color: "bg-violet-500",
    rating: 5,
    text: "I was from a non-IT background. The trainers were incredibly patient and the BPMN process modelling module transformed how I think about business problems. Highly recommended!",
  },
];
...
const FAQS = [
  { q: "Do I need a technical background to become a BA?", a: "No. Business Analysis suits both technical and non-technical professionals. We cover the basics from scratch and gradually introduce SQL, tools, and process modelling. Your domain knowledge is a big advantage." },
  { q: "What is the total course duration?", a: "The course is 3.5 months (~70 days). All sessions are recorded and available on LMS so you never miss a class." },
  { q: "What roles can I target after this course?", a: "You can target roles such as Business Analyst, Functional Consultant, Product Analyst, Systems Analyst, Scrum Master (junior), and IT Business Analyst across industries." },
  { q: "Is placement 100% guaranteed?", a: "We provide 100% placement assistance — resume building, mock interviews, and direct referrals to 500+ hiring partners. We support you until you land your role." },
  { q: "What certifications will I receive?", a: "You'll receive a Great Hire Training Certificate recognized certificate. We also prepare you for ECBA and CCBA certification exams." },
  { q: "What is the course fee and EMI options?", a: "The course fee is ₹38,000 (inclusive of all materials, tools access, projects & placement support). EMI starts from ₹7,000/month. No cost EMI on select cards." },
];
  ...
  const handleSubmit = async () => {
    ...
    try {
      await fetch(`${import.meta.env.VITE_API_URL}/api/v1/courses/enquiry`, {
        ...
        body: JSON.stringify({ ...form, courseName: "Business Analytics", type: "demo" }),
      });
      setLoading(false);
      setDone(true);
    } catch (_) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative border border-gray-100 dark:border-gray-700">
        ...
        {done ? (
          <div className="p-8 text-center"><div className="text-5xl mb-4">🎓</div><h3 className="text-xl font-black text-gray-900 dark:text-white mb-2">Demo Booked!</h3><p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Our counsellor will contact you within 2 hours to confirm your free demo session.</p><button onClick={onClose} className="bg-indigo-600 text-white px-8 py-3 rounded-xl font-semibold text-sm hover:bg-indigo-700">Got it!</button></div>
        ) : (
          <div className="p-6">
            <div className="mb-5 pb-4 border-b border-gray-100 dark:border-gray-700"><p className="text-xs text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-widest mb-1">Book Free Demo</p><h3 className="text-xl font-black text-gray-900 dark:text-white">Business Analytics</h3><p className="text-sm text-gray-500 dark:text-gray-400 mt-1">🎯 Free demo class — no commitment required!</p></div>
            <div className="space-y-4">
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white ${
              ...
              <div><label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Preferred Mode</label><select value={form.mode} onChange={(e) => setForm({ ...form, mode: e.target.value })} className="w-full border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"><option className="dark:bg-gray-800">Online</option><option className="dark:bg-gray-800">Offline</option><option className="dark:bg-gray-800">Hybrid</option></select></div>
              <button onClick={handleSubmit} disabled={loading} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1 disabled:opacity-60">{loading ? "Submitting..." : "Book Free Demo Class →"}</button>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-indigo-950 to-indigo-900 dark:from-gray-950 dark:via-indigo-950 dark:to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: "radial-gradient(circle at 20% 80%, #6366f1 0%, transparent 50%), radial-gradient(circle at 80% 20%, #8b5cf6 0%, transparent 50%)" }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            <div className="lg:col-span-2">
              <div className="flex flex-wrap gap-2 mb-5">
                ...
                <span className="bg-white/10 text-white text-xs font-medium px-3 py-1 rounded-full border border-white/20">Business Analysis</span>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4">
                Business Analyst<br /><span className="text-yellow-300">Course with Agile</span><br />
                <span className="text-2xl sm:text-3xl font-bold text-indigo-200">in Hyderabad</span>
              </h1>
              <p className="text-indigo-100 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">Master Requirements Engineering, BPMN, Agile-Scrum, JIRA, SQL, Power BI and more. Build industry-standard BRDs and get placed as a BA at top MNCs through Great Hire's hiring network.</p>
              <div className="flex flex-wrap gap-6 mb-8">
                {[{ val: "4.8★", label: "Rating" }, { val: "1,600+", label: "Students" }, { val: "3.5 Months", label: "Duration" }, { val: "100%", label: "Placement" }].map((s) => (
              ...
              <div className="flex flex-wrap gap-4 mt-6 text-xs text-indigo-200">
                <span>✅ No Cost EMI Available</span><span>✅ ECBA & CCBA Cert Prep</span><span>✅ Free Demo Class</span>
              </div>
            </div>
            ...
            <div className="hidden lg:block">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.8</span><span className="text-xs text-gray-400">(1,600+ reviews)</span></div>
                ...
                <div className="space-y-2.5 mb-5">
                  {["📅 Next batch starts April 14", "⏱ 3.5 months duration", "🎖 Dual Certification", "💼 100% Placement Support", "🔄 Online + Offline modes", "🎁 Lifetime LMS Access"].map((item) => (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-14">
            ...
            {/* Overview */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-4 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Course Overview</h2>
              <div className="bg-indigo-50 dark:bg-gray-800/60 border border-indigo-100 dark:border-gray-700 rounded-2xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed mb-4">The <strong className="text-gray-900 dark:text-white">Business Analyst Course</strong> at Great Hire is a 3.5-month job-oriented program covering the full BA lifecycle — from requirements elicitation and BPMN process modelling to Agile-Scrum, SQL, and stakeholder reporting with Power BI.</p>
                <p className="text-gray-700 dark:text-gray-300 text-base leading-relaxed">With real BRD and SRS projects, live Agile sprint simulations, and direct placement support through Great Hire's 500+ company network, this is the most practical BA course in Hyderabad.</p>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[{ icon: "⏱", label: "Duration", val: "3.5 Months" }, { icon: "📚", label: "Modules", val: "7 Modules" }, { icon: "🖥", label: "Mode", val: "Online + Offline" }, { icon: "🌐", label: "Language", val: "English / Telugu" }].map((item) => (
                  <div key={item.label} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4 text-center shadow-sm"><p className="text-2xl mb-1">{item.icon}</p><p className="text-xs text-gray-400 dark:text-gray-400 font-medium mb-0.5">{item.label}</p><p className="text-sm font-bold text-gray-900 dark:text-white">{item.val}</p></div>
                ))}
              </div>
            </section>
            ...
            {/* Highlights */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Why This Course?</h2>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Course Curriculum</h2>
            ...
            {/* Tools */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Tools & Technologies</h2>
            ...
            {/* Batches */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Upcoming Batches</h2>
              <div className="space-y-4">
                {BATCHES.map((b) => (
            ...
            {/* Testimonials */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Student Reviews</h2>
            ...
            {/* FAQs */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 flex items-center gap-2"><span className="w-1 h-7 bg-indigo-600 rounded-full inline-block"></span>Frequently Asked Questions</h2>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6">
                <div className="flex items-center gap-2 mb-1"><Stars /><span className="text-sm font-bold text-gray-700 dark:text-gray-200">4.8</span><span className="text-xs text-gray-400">(1,600+)</span></div>
                ...
                <div className="space-y-2.5 mb-5 text-sm text-gray-700 dark:text-gray-300">
                  {["📅 Next batch: April 14, 2025", "⏱ Duration: 3.5 months", "🎖 Dual Certification", "💼 100% Placement Support", "🔄 Online + Offline modes", "🎁 Lifetime LMS Access", "👥 Batch size: 15 students"].map((item) => (<p key={item} className="flex items-start gap-2">{item}</p>))}
                </div>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-violet-700 dark:from-indigo-700 dark:to-violet-800 rounded-2xl p-5 text-white text-center">
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent("📋 Check out this Business Analyst Course at Great Hire! Get placed as a BA at top MNCs with 100% placement support.\n" + window.location.href)}`}
                  target="_blank"
      ...
      {/* Footer CTA Banner */}
      <section className="bg-gradient-to-r from-indigo-700 to-violet-700 dark:from-indigo-800 dark:to-violet-900 py-14 mt-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">Start Your Business Analyst Journey Today</h2>
          <p className="text-indigo-100 text-base sm:text-lg mb-8 leading-relaxed">Join 1,600+ students who've built thriving BA careers with Great Hire's comprehensive program.</p>
      ...
      <Suspense fallback={null}>
        {showEnroll && <CourseEnrollModal onClose={() => setShowEnroll(false)} courseName="Business Analyst" amount={38000} accentColor="blue" />}
        {showCounsellor && <TalkToCounsellorModal courseName="Business Analyst" onClose={() => setShowCounsellor(false)} />}
      </Suspense>
    </div>
  );
}
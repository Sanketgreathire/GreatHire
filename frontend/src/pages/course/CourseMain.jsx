...
function EnrollModal({ course, onClose, type = "enquiry" }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative animate-fade-in">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 text-xl font-bold w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
        >
          ×
        </button>
        ...
        {submitted ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Enrollment Requested!</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Our team will contact you within 24 hours to confirm your batch.</p>
          ...
          <div className="p-6">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
              ...
              <div>
                <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">Enrolling in</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Full Name</label>
                <input
                  required
                  type="text"
              ...
              <div>
                <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide block mb-1.5">Email Address</label>
                <input
                  required
                  type="email"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                >

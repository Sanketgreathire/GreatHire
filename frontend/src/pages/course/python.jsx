          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <button onClick={() => form.name && form.email && form.phone && setDone(true)}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1">
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-5 text-white text-center">
                ...
                <button className="bg-white text-blue-600 font-bold text-xs px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors">
                  Share & Earn
                </button>
              </div>
            </div>

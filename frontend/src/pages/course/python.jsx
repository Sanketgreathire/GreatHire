...
const CURRICULUM = [
  ...
  },
  {
    ...
    topics: [
      ...
      "Task Management App with REST API",
      "Portfolio Website Deployment",
      "Resume Building & LinkedIn Optimization",
      "Mock Interviews & HR Round Preparation",
      "Aptitude & Coding Round Practice",
    ],
  },
];
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    text: "I had zero coding background and now I'm a working professional. The curriculum is very well structured from basics to advanced. Mock interviews were the game changer!",
  },
];
...
const FAQS = [
  {
    q: "Do I need any prior programming knowledge?",
    a: "No prior experience is required. We start from absolute scratch — Python basics, HTML, CSS — and gradually move to advanced concepts. Anyone with basic computer knowledge can join.",
  },
  {
    q: "What is the course duration?",
    a: "The course is 6 months (approximately 100 days of training). Duration may slightly vary based on batch type — weekday batches may be faster than weekend batches.",
  },
  {
    q: "Is placement 100% guaranteed?",
    a: "We provide 100% placement assistance — resume building, mock interviews, and direct referrals to Great Hire's 500+ hiring partner companies. We support you until you land a job.",
  },
  {
    q: "Is the course available online?",
    a: "Yes! We offer both online (live interactive sessions) and offline (classroom) modes. Hybrid batches are also available. All sessions are recorded and accessible on our LMS.",
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4">
                ...
                <span className="text-2xl sm:text-3xl font-bold text-blue-200">in Hyderabad</span>
              </h1>

              <p className="text-blue-100 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
                Master Python, Django, React, MySQL, AWS and more with real-world projects. Get placed in top IT companies through Great Hire's exclusive hiring network — 100% placement assistance included.
              </p>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 space-y-5">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-5 text-white text-center">
                ...
                <a
                  href={`https://wa.me/?text=${encodeURIComponent("🐍 Check out this Full Stack Python Developer Course at Great Hire! Get placed in top IT companies with 100% placement support.\n" + window.location.href)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block bg-white text-blue-600 font-bold text-xs px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors">
                  Share & Earn
                </a>
              </div>
            </div>
